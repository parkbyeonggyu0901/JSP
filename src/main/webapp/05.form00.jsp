...
<body>
	<h3>회원가입</h3>
	<form action="05.form01.jsp" name="member" method="post">
		...
		<p>취미 : 독서<input type="checkbox" name="hooby" value="독서" checked>
				운동<input type="checkbox" name="hooby" value="운동">
				영화<input type="checkbox" name="hooby" value="영화">
